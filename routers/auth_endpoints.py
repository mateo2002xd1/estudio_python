...
from services.auth_service import login_usuario, registro_usuario
from schemas.usuarios_schema import UsuarioResponse, UsuarioRegistro, UsuarioLogin
...
@router.patch("/{id}/login/", response_model=UsuarioResponse)
